...
func GetRu() *Bundle {
	return &Bundle{
		...
		History: History{
			...
			EventLine:      "● <b>%s</b>",
			MetaLine:       "<i>%s</i> · %s",
			SubtaskAdded:   "● <b>Добавлена подзадача:</b> %s",
			SubtaskDone:    "● <b>Выполнена подзадача:</b> %s",
			SubtaskUndone:  "● <b>Возобновлена подзадача:</b> %s",
			SubtaskDeleted: "● <b>Удалена подзадача:</b> %s",
			SubtaskEdited:  "● <b>Изменена подзадача:</b> %s → %s",
			CommentAdded:   "● <b>Добавлен комментарий:</b> %s",
			CommentEdited:  "● <b>Изменен комментарий:</b> %s → %s",
			CommentDeleted: "● <b>Удален комментарий:</b> %s",
		},
	}
}
